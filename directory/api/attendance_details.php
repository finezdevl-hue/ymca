        ...
        if($action=="load_data"){
            ...
            try{
                ...
                if($_POST['val']== ''){
                    ...
                    WHERE m.id = ? AND MONTH(f.date) = ? AND YEAR(f.date) = ?
        ...
        if($action=="load_attendance"){
            ...
            try{
                ...
                $sqldatarows="";
                    ...
                    WHERE m.email = '" . $_SESSION['email'] . "' AND MONTH(f.date) = ? AND YEAR(f.date) = ? order by f.date DESC";
