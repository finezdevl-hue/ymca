...
<head>
    ...
    <script>
        ...
        // search box for search families in group start
        ...
        // search box for search families in group end

        // function to load the families in the group start
        function loadData(page) {
            $('#hdn_current_page').val(page); //used for Status Update function
            console.log("Loading data for page:", page);
            $.ajax({               
               type: "POST",
               url: "api/group_family.php",
               data: {
               ...
               val:$('#txt_search').val()
                ...
                success: function(data) {  
                    ...
                    for (var i = 0; i < obj[1].length; i++) {
                        ...
                        htm=htm+ "<a onclick='deleteFamily("+obj[1][i].id+");' class='btn btn-xs btn-danger'><i class='fa fa-trash'></i> delete</a>";
                        htm=htm+ "</div>";
                        htm=htm+ "</div>";
                        htm=htm+ "</div>";
                        htm=htm+ "</div>"   
        ...
        //function to load families in the group end
