...
<head>
    ...
    <script>
        ...
        // function to load recieveble payment detail start
        function loadData(page) {
            $('#hdn_current_page').val(page); //used for Status Update function
            console.log("Loading data for page:", page);
            $.ajax({               
               type: "POST",
               url: "api/payment_recieveble.php",
               data: {
                action: 'load_data',
                page: page, 
                // val:$('#txt_search').val()
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < obj[1].length; i++) {
                        ...
                        // htm=htm+ "<td><button type='button' class='fa fa-edit btn btn-primary btn-xs' onclick='editPayment("+obj[1][i].id+",\"" +obj[1][i].date+ "\",\"" +obj[1][i].head+ "\",\"" +obj[1][i].particuler+ "\",\"" +obj[1][i].amount+ "\");'>Edit</button></td>";
        ...
        // function to load recieveble payment details end
        
    </script>

    <script>

        // function for popup to edit recieveble Payment details  start
        ...
        // function for popup to edit recieveble Payment details end

        //function for poup to add new recieveble payment details start
        function addPayment(){
            $('#paymentModel').modal('show');
        }
        //function for pop to add new recieveble payment details end

        //function for close the popup for recieveble payment details start
        function closeaddPayment(){
            $('#payment_form')[0].reset();
            $("hdn_id").val(0);
            $('#paymentModel').modal('toggle');
        }
        // function for close the popup for recieveble payment details end

        //function to save recieveble payment details start
        ...
        // function to save recieveble payment details end

        //function to inject heads dropdwon to the popup for add recieveble payment start
        function load_heads(){
            $.ajax({
        ...
        // function to inject heads dropdown to the popup for add recieveble payment end
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
                ...
                <div class="col-sm-4">
                    <div class="title-action">
                        <div class="ibox-tools">
                             <button type="button" class="btn btn-primary btn-xs" onclick="addPayment(0)">Recieveble Payment</button>
                        </div>
                    </div>
                </div>
            </div>
         ...
         <!-- popup modal for add recieveble payment starts -->
        <div class="modal inmodal" id="paymentModel" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content animated bounceInRight">
                    <form method="POST" id="payment_form">
                        <div class="modal-body">
                            <div class="form-group"><label>Date</label><input type="date" id="date" name="date" placeholder=""  class="form-control"></div>
                            ...
                            <div class="form-group"><label>Recieveble</label><input type="text" id="recieveble" name="recieveble" placeholder="Recieveble Payment"  class="form-control"></div>
                            <div class="form-group"><label>Recieved</label><input type="text" id="recieved" name="recieved" placeholder="Recieved Payment"  class="form-control"></div>
                            <div id="select_heads">
        ...
        <!-- popup modal for add recieveble payment ends -->
    </div>
