...
<head>
    ...
    <script>
        ...
        // function to load previous year payment details start
        function loadData(page) {
            $('#hdn_current_page').val(page); //used for Status Update function
            console.log("Loading data for page:", page);
            $.ajax({               
               type: "POST",
               url: "api/prev_payment_trans.php",
               data: {
                action: 'load_data',
                page: page, 
                // val:$('#txt_search').val()
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < obj[1].length; i++) {
                        ...
                        // htm=htm+ "<td><button type='button' class='fa fa-trash btn btn-danger btn-xs' onclick='deleteFeeDetails("+obj[1][i].id+","+obj[1][i].payable_id+",\"" +obj[1][i].amount+ "\");'>Delete</button></td>";
                        htm=htm+ "</tr>";
                    }                
                    htm=htm+ "</tbody>";
                    htm=htm+ "</table>";
        ...
        // function to load previous year payment details end
