...
<head>
               ...
               data: {
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < obj[1].length; i++) {
                        ...
                        htm = htm + "<td>" + (obj[1][i].receiveble_fees - obj[1][i].total_received_fees) + "</td>";
                        if(obj[1][i].iscomplete == 0){
                            htm=htm+ "<td><button type='button' class='fa fa-money btn btn-primary btn-xs' onclick='editPayment("+obj[1][i].recieveble_id+","+obj[1][i].member_id+",\"" +obj[1][i].head+ "\",\"" +obj[1][i].total_received_fees+ "\",\"" +obj[1][i].receiveble_fees+"\",\"" +obj[1][i].discription+"\");'>Pay</button></td>";
                        }
                        else{
    ...
    <script>
        ...
        function editPayment(id,member_id,head,fees,fees_receiveble,discription){
            var balance = fees_receiveble-fees;
            $("#hdn_member_id").val(member_id);
            $("#selected_head").val(head);
            $("#amount").val(balance);
            $("#amount_paid").val(fees);
                ...
                <div class="modal-content animated bounceInRight">
                    <form method="POST" id="payment_form">
                        <div class="modal-body">
                            ...
                            <div class="form-group"><label>Particular</label><input type="text" id="discription" name="particular" placeholder="Particular"  class="form-control" readonly></div>
