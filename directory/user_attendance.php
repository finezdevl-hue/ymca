                                    ...
                                    success: function(resData) {
                                        ...
                                        if (isPresent) {
                                            ...
                                            $('#member-action-area').html(htm);
                                             ...
                                             actionHtm += '  <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 12px; width: 100%;">';
                                             actionHtm += '    <button onclick="markMyAttendance()" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white; border: none; border-radius: 16px; padding: 14px 6px; font-size: 13.5px; font-weight: 800; cursor: pointer; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 6px; box-shadow: 0 4px 14px rgba(16,185,129,0.3); font-family: \'Inter\', sans-serif; transition: all 0.2s;"><i class="fa fa-check-circle" style="font-size: 20px;"></i> Present</button>';
                                             actionHtm += '    <button onclick="markMyTempStatus(\'absent\')" style="background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%); color: white; border: none; border-radius: 16px; padding: 14px 6px; font-size: 13.5px; font-weight: 800; cursor: pointer; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 6px; box-shadow: 0 4px 14px rgba(239,68,68,0.3); font-family: \'Inter\', sans-serif; transition: all 0.2s;"><i class="fa fa-times-circle" style="font-size: 20px;"></i> Absent</button>';
                                             actionHtm += '  </div>';
                                             actionHtm += '</div>';
