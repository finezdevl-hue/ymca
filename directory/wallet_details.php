...
<head>
    ...
    <style>
        /* Custom styles for Wallet Details */
        ...
        .btn-delete-custom {
            ...
            height: 32px;
            border-radius: 8px;
            background-color: rgba(239, 44, 44, 0.08) !important;
            color: #ef4444 !important;
            border: 1px solid rgba(239, 44, 44, 0.15) !important;
            cursor: pointer;
            transition: all 0.2s ease;
        }
        ...
        .btn-delete-custom:hover {
            ...
            box-shadow: 0 4px 10px rgba(239, 44, 44, 0.2) !important;
        }
    ...
    <script>
               ...
               data: {
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < obj[1].length; i++) {
                        ...
                        htm=htm+ "<td style='text-align: right;'><a onclick='deleteWallet("+obj[1][i].id+");' class='btn-delete-custom' title='Delete Record'><i class='fa fa-trash' style='font-family: FontAwesome !important;'></i></a></td>";
                        htm=htm+ "</tr>";
                    }                
                    htm=htm+ "</tbody>";
                    htm=htm+ "</table>";
        ...
        // function to delete wallet details start
                ...
                if (isConfirm){
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            close_overlay();
                            alertwarning('Deleted Successfully');
                            // Reload the balance top widget (using simple reload or we can let it refresh)
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="settings-card-wrapper">
                ...
                <div class="wallet-profile-header">
                    <div class="user-info-block">
                        <div class="user-avatar-circle">
                            <?php 
                                $initial = strtoupper(substr($_SESSION['first_name'], 0, 1));
                                echo $initial;
                            ?>
                        </div>
                        <div class="user-name-details">
                            <h2><?php echo $_SESSION['first_name'] . " " . $_SESSION['middle_name'] . " " . $_SESSION['last_name']; ?></h2>
                            <p><i class="fa fa-user-circle"></i> Member Account Wallet</p>
                        </div>
                    </div>
                ...
                <!-- Controls Row (search date & back button) -->
                <div class="controls-row-modern">
                    <a href="wallet.php" class="btn-back-custom"><i class="fa fa-chevron-left" style="font-family: FontAwesome !important;"></i> Back to Wallets</a>
